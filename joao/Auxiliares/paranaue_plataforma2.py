...
from Auxiliares.paranaue_plataforma3 import *


def plataforma2(janela, nome, score):
    ...
    plat1.set_position(base_plat.width + plat1.width - 100, janela.height - base_plat3.height * 2 - plat1.height)
    terra1.set_position(janela.width - base_plat3.width - 250, janela.height - base_plat3.height * 2 - terra1.height)
    terra2.set_position(base_plat.width + plat1.width - 100, janela.height - base_plat3.height * 2 - terra1.height)
    grama1.set_position(janela.width - base_plat3.width - 250, janela.height - base_plat3.height * 2 - terra1.height - grama1.height)
    grama2.set_position(base_plat.width + plat1.width - 100, janela.height - base_plat3.height * 2 - terra1.height - grama2.height)
    player.set_position(0, janela.height - base_plat.height - player.height)
    guarda1.set_position(base_plat.width + plat1.width - 20, janela.height - base_plat3.height * 2 - grama1.height - terra1.height - guarda1.height)
    guarda2.set_position(janela.width - base_plat3.width / 2, janela.height - base_plat3.height - guarda2.height)
    ...
    while True:
        fundo.draw()
        if player.collided(base_plat) or player.collided(grama2) or player.collided(base_plat3) or player.collided(grama1):
